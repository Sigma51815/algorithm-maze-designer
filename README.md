...
| 文档 | 说明 |
|------|------|
| [`PROJ_GUIDE.md`](PROJ_GUIDE.md) | **项目交接指南** — 筛查/检查/强化方向 |
| [`PROJECT_WORKFLOW.md`](PROJECT_WORKFLOW.md) | **项目运转流程** — 架构/线程/数据流全解 |
...
| [`docs/输入输出说明/input说明.txt`](docs/输入输出说明/input说明.txt) | JSON 格式规范 |
