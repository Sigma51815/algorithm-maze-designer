...
| 文件 | 说明 |
|------|------|
| `docs/01-四种迷宫生成方法.md` | 四种迷宫生成算法原理与实现 |
| `docs/02-四种算法复杂度风格特性分析.md` | 复杂度 / 风格 / 特性对比 |
| `docs/03-遗传算法与对抗模式优化设计.md` | GA + 对抗式资源放置设计 |
| `docs/04-评估指标与优化效果衡量.md` | D/B/C 公式与评估指标（已同步新公式） |
| `docs/05-其他-交叉测试矩阵与项目架构补充.md` | 交叉测试矩阵与架构补充 |
...
- 新增 7 份文档（见 2.1），其中 `docs/04-评估指标与优化效果衡量.md` 已同步新 D/B/C 公式与参数速查表。
...
- **合并后 main HEAD**：`22930b7`
- 合并后 main 的工作树与已通过自测的 polish 工作树完全一致。
