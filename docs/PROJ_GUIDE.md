...
| 文档 | 路径 | 说明 |
|------|------|------|
| 任务设计书 | `任务设计书.md` | 课设评分标准 |
| 课程设计说明 | `课程设计说明.md` | 课程整体设计思路 |
| 验收对照清单 | `验收对照清单.md` | 助教验收对照项 |
| AI 玩家接口说明 | `AI玩家接口说明.md` | 交叉测试 JSON 接口 |
| 优化策略说明 | `优化策略说明.md` | GA/适应度/协同进化 |
| 项目运转流程 | `PROJECT_WORKFLOW.md` | 架构/线程/数据流 |
| 迷宫设计方案 | `方案设计思路/方案甲_迷宫设计.md` | PAIRED/GA 优化设计 |
| AI 玩家方案 | `方案设计思路/方案乙_AI玩家.md` | 贪心/RL/DRQN 设计 |
| 优化器指南 | `方案设计思路/OPTIMIZER_GUIDE.md` | 无头优化器使用 |
| 输入说明 | `输入输出说明/input说明.txt` | 交叉测试 JSON 格式 |
